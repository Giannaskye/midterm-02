...
public class Midterm2 {
        ...
        static class Person {
                ...
                /**
                 * Merges two collections of different types into a new collection using a
                 * BiFunction.
                 *
                ...
                public static void main(String[] args) {
                        ...
                        BiFunction<Double, Double, String> comparisonResult = (a, b) -> a + " vs " + b + ": "
                        ...
                        BiFunction<Character, Integer, String> positionedLetter = (letter, position) -> position + ". "
                                        + letter;
